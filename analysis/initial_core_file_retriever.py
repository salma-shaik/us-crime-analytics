...
def get_top_level_vars(fnl_main):
    ...
    initial_core_df = fnl_main.loc[:, ['ORI', 'AGENCY', 'placename', 'Govt_level', 'place_fips', 'STATEFP', 'CNTY',
                                       ...
                                       'property_crime_rate','total_main_crime_rate','violent_arrests', 'drug_arrests_black',
                                       'drug_arrests_white', 'property_arrests', 'total_main_arrests', 'violent_arrests_rates',
                                       'total_main_arrests_rates', 'sale_drug_total_tot_arrests_rate', 'drug_arrests_black_rate',
                                       'drug_arrests_white_rate','disorder_arrests_black_index_rate', 'disorder_arrests_white_index_rate',
                                       'poss_drug_total_tot_arrests_rate', 'disorder_arrests_tot_index', 'disorder_arrests_black_index',
                                       'disorder_arrests_tot_index_rate', 'disorder_arrests_white_index',
    ...
    initial_core_df.to_csv('/Users/salma/Research/us-crime-analytics/data/analysis/initial_core_file.csv', index=False)
...
get_top_level_vars(pd.read_csv('/Users/salma/Research/us-crime-analytics/data/analysis/final_main_ncrp_incarc_rep_code_enhanced.csv'))